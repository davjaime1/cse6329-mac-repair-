...
import mac_repair.model.MARErrorMsgs;
...
public class MARTest {
	...
	public void test(	int testcaseNo, String action, String marID, String facilityName, String facilityType,String urgency, String description, String reportedUser, String date, String assignedTo, String assignedDate, String estimateOFRepair, String errorMsg,    
			String marNumberError,    String descriptionError ,  String assignedDateError,    String assignedToError ) {

		mar.setAssignedMAR(marID, facilityName, facilityType, urgency, description, reportedUser, date, assignedTo, assignedDate, estimateOFRepair); 
