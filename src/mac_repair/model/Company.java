...
import mac_repair.data.CompanyDAO;
...
public class Company implements Serializable
{
    ...
    private String validateCompany_name(String company_name)
    {
        ...
        else if (Character.isLowerCase(company_name.charAt(0)))
