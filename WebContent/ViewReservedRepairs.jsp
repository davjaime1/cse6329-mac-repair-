...
<input name="errMsg"  value="<c:out value='${errorMsgs}'/>" type="text"  style ="background-color: white; color: red; border: none; width:800px" disabled="disabled">
 ...
 <form action="/mac_repair/RepairerController?action=listSpecificReservedRepairs" method="post">          
       <table border="1" class="myTable"> 
 		...
 		<c:forEach items="${REPAIRERS}" var="item" varStatus="status">
            ...
            <td> <a href="/mac_repair/RepairerViewAssignedController?action=listSpecificReservedRepairs&id=${item.marnum}">View</a></td>
			</tr>
		</c:forEach>
 </table>
 </form>
