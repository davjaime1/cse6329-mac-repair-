...
<input name="errMsg"  value="<c:out value='${errorMsgs}'/>" type="text"  style ="background-color: white; color: red; border: none; width:800px" disabled="disabled">
 ...
 <form action="/mac_repair/FM_MARController?action=listSpecificCompany" method="post">          
       <table border="1" class="myTable"> 
 		...
 		<c:forEach items="${MARS}" var="item" varStatus="status">
			<tr class="myTableRow">
			<td class="myTableCell" style="padding-right: 20px; "><a href="/mac_repair/FM_MARController?action=listSpecificCompany&id=${item.marID}"><c:out value="${item.marID}" /></a></td>
