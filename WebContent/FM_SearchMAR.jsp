...
<tr>
	...
	<tr>
  	<td> MAR Number: </td>
 	<td> <input name="idmarnumber" value="<c:out value='${mar.marID}'/>" type="text" maxlength="45">  </td>
    ...
    <tr>
    <td> Facility Name: </td>
    <td> <input name="idfacilityname" value="<c:out value='${mar.facilityName}'/>" type="text" maxlength="16"> </td>
